...
import delAllPMTypeNotCmd  = require("../../js/dolphin/DeletedAllPresentationModelsOfTypeNotification")
...
//            CodecTestHelper.testCodingCommand(new DataCommand([a:1, b:2]))//todo: to be implement
            ...
            this.isTrue(CodecTestHelper.testCodingCommand(new delAllPMTypeNotCmd.dolphin.DeletedAllPresentationModelsOfTypeNotification("type")))
